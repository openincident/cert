...
s3_menu_dict = {
    ...
    "hrm": {
        ...
        "conditional3": [
             ...
             False, aURL(f="human_resource",
               ...
               [T("List All"),
                False, aURL(f="human_resource",
                            ...
                            vars=dict(group="volunteer"))],
               [T("Report"),
                False, aURL(f="experience",
                            args="analyze",
                            vars=dict(rows="person_id",
                                      cols="event_id$type",
                                      fact="event_id$hours",
                                      aggregate="sum"))],
               [T("Import"),
            ...
            [T("Events"), False, aURL(f="event"), [
                [T("New Event"), False, aURL(f="event",
                                            args="create")],
                [T("List All"), False, aURL(f="event")],
                [T("Import Participant List"),
                 False, aURL(p="create",
                             f="experience",
                             args=["import.xml"])],
            ]],
            #[T("Participants"), False, aURL(f="experience"), [
                #[T("Manual Input"),
                 #False, aURL(p="create",
                             #f="experience",
                             #args=["create"])],
                #[T("Import CSV"),
                 #False, aURL(p="create",
                             ...
                             #args=["import.xml"])],
            #]],
            [T("Contact Lists"), False, aURL(f="group"), [
                [T("New Contact List"), False, aURL(f="group",
                                            args="create")],
                [T("List All"), False, aURL(f="group")],
            ]],
